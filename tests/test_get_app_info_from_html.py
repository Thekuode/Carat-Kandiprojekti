...
COMPLETE_VALUE_TEST_BATTERY = [
    #Rating tests
    ("Review is integer", "3", "100", "1000", "Jan 1, 2025"),
    ("Review is floating point .1", "3.1", "100", "1000", "Jan 1, 2025"),
    ("Review is floating point .12", "3.12", "100", "1000", "Jan 1, 2025"),
    ("Review is floating point .123", "3.123", "100", "1000", "Jan 1, 2025"),
    #Reviw count tests, integer
    ("Review count is integer", "3", "100", "1000", "Jan 1, 2025"),
    ("Review count is integer postfix K","3", "100K", "1000", "Jan 1, 2025"),
    ("Review count is integer postfix M","3", "100M", "1000", "Jan 1, 2025"),
    ("Review count is integer postfix B","3", "100B", "1000", "Jan 1, 2025"),
    ("Review count is integer postfix K+","3", "100K+", "1000", "Jan 1, 2025"),
    ("Review count is integer postfix M+","3", "100M+", "1000", "Jan 1, 2025"),
    ("Review count is integer postfix B+","3", "100B+", "1000", "Jan 1, 2025"),
    #Reviw count tests, floating point
    ("Review count is float postfix K","3", "1.58K", "1000", "Jan 1, 2025"),
    ("Review count is float postfix M","3", "1.58M", "1000", "Jan 1, 2025"),
    ("Review count is float postfix B","3", "1.58B", "1000", "Jan 1, 2025"),
    ("Review count is float postfix K+","3", "1.58K+", "1000", "Jan 1, 2025"),
    ("Review count is float postfix M+","3", "1.58M+", "1000", "Jan 1, 2025"),
    ("Review count is float postfix B+","3", "1.58B+", "1000", "Jan 1, 2025"),
    #Download count tests, integer
    ("Download count is integer", "3", "100", "1000", "Jan 1, 2025"),
    ("Download count is integer postfix K","3", "100K", "1000K", "Jan 1, 2025"),
    ("Download count is integer postfix M","3", "100M", "1000M", "Jan 1, 2025"),
    ("Download count is integer postfix B","3", "100B", "1000B", "Jan 1, 2025"),
    ("Download count is integer postfix K+","3", "100K+", "1000K+", "Jan 1, 2025"),
    ("Download count is integer postfix M+","3", "100M+", "1000M+", "Jan 1, 2025"),
    ("Download count is integer postfix B+","3", "100B+", "1000B+", "Jan 1, 2025"),
    #Download count tests, floating point
    ("Download count is float postfix K","3", "1.58K", "1.58K", "Jan 1, 2025"),
    ("Download count is float postfix M","3", "1.58M", "1.58M", "Jan 1, 2025"),
    ("Download count is float postfix B","3", "1.58B", "1.58B", "Jan 1, 2025"),
    ("Download count is float postfix K+","3", "1.58K+", "1.58K+", "Jan 1, 2025"),
    ("Download count is float postfix M+","3", "1.58M+", "1.58M+", "Jan 1, 2025"),
    ("Download count is float postfix B+","3", "1.58B+", "1.58B+", "Jan 1, 2025"),
    #Months
    ("Month is Jan","3", "1.58K", "1.58K", "Jan 1, 2025"),
    ("Month is Feb","3", "1.58M", "1.58M", "Feb 1, 2025"),
    ("Month is Mar","3", "1.58B", "1.58B", "Mar 1, 2025"),
    ("Month is Apr","3", "1.58K+", "1.58K+", "Apr 1, 2025"),
    ("Month is May","3", "1.58M+", "1.58M+", "May 1, 2025"),
    ("Month is Jun","3", "1.58B+", "1.58B+", "Jun 1, 2025"),
    ("Month is Jul","3", "1.58K", "1.58K", "Jul 1, 2025"),
    ("Month is Aug","3", "1.58M", "1.58M", "Aug 1, 2025"),
    ("Month is Sep","3", "1.58B", "1.58B", "Sep 1, 2025"),
    ("Month is Oct","3", "1.58K+", "1.58K+", "Oct 1, 2025"),
    ("Month is Nov","3", "1.58M+", "1.58M+", "Nov 1, 2025"),
    ("Month is Dec","3", "1.58B+", "1.58B+", "Dec 1, 2025"),
    #Date is 1,10,20,30
    ("Date is 1","3", "1.58K", "1.58K", "Jan 1, 2025"),
    ("Date is 10","3", "1.58M", "1.58M", "Feb 10, 2025"),
    ("Date is 20","3", "1.58B", "1.58B", "Mar 20, 2025"),
    ("Date is 30","3", "1.58B", "1.58B", "Mar 30, 2025"),
    #Year is 1900, 2000, 2010, 2020, 2030, 2040
    ("Year is 1900","3", "1.58K", "1.58K", "Jan 1, 1900"),
    ("Year is 2000","3", "1.58M", "1.58M", "Feb 10, 2000"),
    ("Year is 2010","3", "1.58B", "1.58B", "Mar 20, 2010"),
    ("Year is 2020","3", "1.58B", "1.58B", "Mar 30, 2020"),
    ("Year is 2030","3", "1.58B", "1.58B", "Mar 30, 2030"),
    ("Year is 2040","3", "1.58B", "1.58B", "Mar 30, 2040"),
] 

#Test inputs as tuple[str, str, str, str, str]
@pytest.mark.parametrize("test_purpose, rating_value, review_count, download_count, last_updated", COMPLETE_VALUE_TEST_BATTERY)
def test_get_app_info_from_html(test_purpose: str, rating_value: str, review_count: str, download_count:str, last_updated: str) -> None:
    ...
    '''
    expected = (rating_value, download_count, review_count, last_updated)
    result = get_app_info_from_html(mock_html)
    assert result == expected

#Test inputs as tuple[str, str, str, str, str]
@pytest.mark.parametrize("test_purpose, rating_value, review_count, download_count, last_updated", COMPLETE_VALUE_TEST_BATTERY)
def test_get_gov_app_info_from_html(test_purpose: str, rating_value: str, review_count: str, download_count:str, last_updated: str) -> None:
    # test when all the requested information is present
    mock_html = f'''
    <html>
        <body>
...
#Test inputs as tuple[str, str, str, str, str]
@pytest.mark.parametrize("test_purpose, rating_value, review_count, download_count, last_updated", COMPLETE_VALUE_TEST_BATTERY)
def test_get_rewarded_app_info_from_html(test_purpose: str, rating_value: str, review_count: str, download_count:str, last_updated: str) -> None:
    # test when all the requested information is present
    mock_html = f'''
    <html>
        <body>
...
#Test inputs as tuple[str, str, str, str, str]
@pytest.mark.parametrize("test_purpose, rating_value, review_count, download_count, last_updated", COMPLETE_VALUE_TEST_BATTERY)
def test_get_rewarded_gov_app_info_from_html(test_purpose: str, rating_value: str, review_count: str, download_count:str, last_updated: str) -> None:
    # test when all the requested information is present
    mock_html = f'''
    <html>
        <body>
