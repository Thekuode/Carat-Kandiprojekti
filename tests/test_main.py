...
@patch("play_store_fetcher.get_app_info_from_html", return_value=("4.5", "100K+", "1M+", "Last Updated: Jan 1, 2025"))
...
def test_main(mock_save, mock_get_info, mock_request, mock_read) -> None:
    ...
    mock_save.assert_called_with("com.example.app", "4.5", "100K+", "1M+", "Last Updated: Jan 1, 2025", "mock", ANY, ANY, ANY)
